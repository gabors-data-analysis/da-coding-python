...
| [lecture10-intro-to-regression](https://github.com/gabors-data-analysis/da-coding-python/tree/develop/lecture10-intro-to-regression) | binary means, non-parametric regression (lowess), simple linear regression (OLS), analysis of results | [hotels-vienna](https://gabors-data-analysis.com/datasets/#hotels-vienna) | 
